...
sound_t* reduce_mix(mix_t* m){
    ...
    sound_t* out = malloc(sizeof(sound_t));
    out->n_samples = max_length;
    out->samples = malloc(max_length * sizeof(int16_t));
